            ...
            <div>
                ...
                <div className="modal-dialog" role="document">
                    ...
                    <div className="modal-header">
                        <h5 className="modal-title" id="AddModalLabel">เพิ่มรายการงาน</h5>
                    ...
                    <br/>
                        ...
                        <input type="text" className="form-control" placeholder="ต้นทาง" aria-label="" aria-describedby="basic-addon1"/> <br/>
